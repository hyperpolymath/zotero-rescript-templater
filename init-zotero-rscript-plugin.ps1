  ...
  practitioner = @'
{
  ...
  "files": {
    ...
    "install.rdf": "<?xml version=\"1.0\"?>\n<RDF xmlns=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n     xmlns:em=\"http://www.mozilla.org/2004/em-rdf#\">\n  <Description about=\"urn:mozilla:install-manifest\">\n    <em:id>{{ProjectName}}@zotero.org</em:id>\n    <em:name>{{ProjectName}}</em:name>\n    <em:version>{{version}}</em:version>\n    <em:description>Professional Zotero plugin by {{AuthorName}}</em:description>\n    <em:creator>{{AuthorName}}</em:creator>\n    <em:type>2</em:type>\n    <em:bootstrap>true</em:bootstrap>\n    <em:targetApplication>\n      <Description>\n        <em:id>zotero@chnm.gmu.edu</em:id>\n        <em:minVersion>5.0</em:minVersion>\n        <em:maxVersion>6.*</em:maxVersion>\n      </Description>\n    </em:targetApplication>\n  </Description>\n</RDF>",
  ...
  researcher   = @'
{
  ...
  "files": {
    ...
    "install.rdf": "<?xml version=\"1.0\"?>\n<RDF xmlns=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n     xmlns:em=\"http://www.mozilla.org/2004/em-rdf#\">\n  <Description about=\"urn:mozilla:install-manifest\">\n    <em:id>{{ProjectName}}@research.zotero.org</em:id>\n    <em:name>{{ProjectName}} Research Edition</em:name>\n    <em:version>{{version}}</em:version>\n    <em:description>Research-focused Zotero plugin with advanced analytics</em:description>\n    <em:creator>{{AuthorName}}</em:creator>\n    <em:type>2</em:type>\n    <em:bootstrap>true</em:bootstrap>\n    <em:targetApplication>\n      <Description>\n        <em:id>zotero@chnm.gmu.edu</em:id>\n        <em:minVersion>5.0</em:minVersion>\n        <em:maxVersion>7.*</em:maxVersion>\n      </Description>\n    </em:targetApplication>\n  </Description>\n</RDF>",
  ...
  student      = @'
{
  ...
  "files": {
    ...
    "install.rdf": "<?xml version=\"1.0\"?>\n<RDF xmlns=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n     xmlns:em=\"http://www.mozilla.org/2004/em-rdf#\">\n  <Description about=\"urn:mozilla:install-manifest\">\n    <em:id>{{ProjectName}}@student.zotero.org</em:id>\n    <em:name>{{ProjectName}} Student Edition</em:name>\n    <em:version>{{version}}</em:version>\n    <em:description>Learning-focused Zotero plugin with educational examples</em:description>\n    <em:creator>{{AuthorName}}</em:creator>\n    <em:type>2</em:type>\n    <em:bootstrap>true</em:bootstrap>\n    <em:targetApplication>\n      <Description>\n        <em:id>zotero@chnm.gmu.edu</em:id>\n        <em:minVersion>5.0</em:minVersion>\n        <em:maxVersion>6.*</em:maxVersion>\n      </Description>\n    </em:targetApplication>\n  </Description>\n</RDF>",
    "chrome.manifest": "content {{ProjectName}} chrome/content/\nlocale {{ProjectName}} en-US chrome/locale/en-US/\nskin {{ProjectName}} default chrome/skin/\noverlay chrome://zotero/content/zoteroPane.xul chrome://{{ProjectName}}/content/overlay.xul",
